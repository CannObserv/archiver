...
down_revision: str | Sequence[str] | None = "a12c1624655c"
...
def upgrade() -> None:
    ...
    """
    op.execute("ALTER INDEX information.ix_iisr_item_bound_desc RENAME TO ix_iisr_item_bound")


def downgrade() -> None:
    """Restore the original (misleading) name."""
    op.execute("ALTER INDEX information.ix_iisr_item_bound RENAME TO ix_iisr_item_bound_desc")
