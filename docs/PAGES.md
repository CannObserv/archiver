...
- Header: `.entity-card` (SCREENS.md § **Header**, `#info-source-heading`, #79) - eyebrow "Information Source", the `url` in `<code>`, `open_button` to it, copyable `info_source_id`, `.detail-grid` (created_at UTC).
