...
4. **Revision History** — `data-table` of `info_item_source_revisions` ordered by `bound_at desc`; columns: Revision (linked to revision detail), Captured, Cache.
