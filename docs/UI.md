...
**POST `/dashboard/info-items/{id}/swap-primary-by-id`** — same swap flow for an existing InfoSource (form field: `info_source_id` ULID). Deactivates old binding, binds new source, best-effort Watcher patch. Redirects 303.
