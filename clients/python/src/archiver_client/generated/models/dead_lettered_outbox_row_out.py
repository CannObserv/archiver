...
if TYPE_CHECKING:
    from ..models.dead_lettered_outbox_row_out_payload import DeadLetteredOutboxRowOutPayload
...
class DeadLetteredOutboxRowOut:
    ...
    Attributes:
        ...
        payload (DeadLetteredOutboxRowOutPayload): The stored payload, as the publisher saw it.
    ...
    event_type: None | str
    last_error: None | str
    payload: DeadLetteredOutboxRowOutPayload
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payload = DeadLetteredOutboxRowOutPayload.from_dict(d.pop("payload"))
