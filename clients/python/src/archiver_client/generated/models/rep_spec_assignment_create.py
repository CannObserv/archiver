...
T = TypeVar("T", bound="RepSpecAssignmentCreate")


@_attrs_define
class RepSpecAssignmentCreate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rep_spec_assignment_create = cls(
            rep_spec_id=rep_spec_id,
            activated_at=activated_at,
        )

        rep_spec_assignment_create.additional_properties = d
        return rep_spec_assignment_create
