...
T = TypeVar("T", bound="PreviewExtractionRequestSourceSpec")
...
class PreviewExtractionRequestSourceSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        preview_extraction_request_source_spec = cls()

        preview_extraction_request_source_spec.additional_properties = d
        return preview_extraction_request_source_spec
