...
T = TypeVar("T", bound="ReprocessDeadLettersRequest")


@_attrs_define
class ReprocessDeadLettersRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reprocess_dead_letters_request = cls(
            entry_ids=entry_ids,
        )

        reprocess_dead_letters_request.additional_properties = d
        return reprocess_dead_letters_request
