...
) -> HTTPValidationError | ProbeResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ProbeResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (ProbeRequest): Input schema for the probe endpoint.
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | ProbeResponse
    """
