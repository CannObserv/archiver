...
) -> HTTPValidationError | list[WatchResponse] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = WatchResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | list[WatchResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | list[WatchResponse]
    """
