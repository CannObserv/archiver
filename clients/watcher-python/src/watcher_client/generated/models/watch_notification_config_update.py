...
T = TypeVar("T", bound="WatchNotificationConfigUpdate")


@_attrs_define
class WatchNotificationConfigUpdate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        watch_notification_config_update = cls(
            is_active=is_active,
            events=events,
        ...
        watch_notification_config_update.additional_properties = d
        return watch_notification_config_update
