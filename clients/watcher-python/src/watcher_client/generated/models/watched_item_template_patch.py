...
if TYPE_CHECKING:
    from ..models.watched_item_template_patch_content_config_type_0 import (
        WatchedItemTemplatePatchContentConfigType0,
    )


T = TypeVar("T", bound="WatchedItemTemplatePatch")


@_attrs_define
class WatchedItemTemplatePatch:
    ...
    Attributes:
        ...
        content_config (None | Unset | WatchedItemTemplatePatchContentConfigType0):
    ...
    content_config: None | Unset | WatchedItemTemplatePatchContentConfigType0 = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.content_config, WatchedItemTemplatePatchContentConfigType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_content_config(
            data: object,
        ) -> None | Unset | WatchedItemTemplatePatchContentConfigType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                content_config_type_0 = WatchedItemTemplatePatchContentConfigType0.from_dict(data)

                return content_config_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | WatchedItemTemplatePatchContentConfigType0, data)
        ...
        watched_item_template_patch = cls(
            title=title,
        ...
        watched_item_template_patch.additional_properties = d
        return watched_item_template_patch
